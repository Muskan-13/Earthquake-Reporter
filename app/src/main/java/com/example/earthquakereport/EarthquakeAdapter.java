...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(listView == null)
        {
            listView= LayoutInflater.from(getContext()).inflate(R.layout.earthquake_listview,parent,false);
        }
        Earthquake current = getItem(position);
        TextView mag=(TextView) listView.findViewById(R.id.magnitude);
        String formattedMagnitude = formatMagnitude(current.getmMagnitude());
